...
2. Skeptical Labs shall be organized simply and inexpensively through a small number of stable and reliable vendors: 
    ...
    2. Email Service ([Protonmail](https://mail.proton.me/)): Free through personal paid plan
    3. Office Suite ([LibreOffice](https://www.libreoffice.org/) & [Google Workspace Free Account](https://workspace.google.com/)): Document storage, sharing, etc. 
    4. Website ([Namecheap](https://www.namecheap.com/), [Github Pages](https://docs.github.com/en/pages), [Pelican](https://docs.getpelican.com/en/stable/index.html), [Cloudflare DNS](https://www.cloudflare.com/)): Basic website and contact information
    5. Primary Bank ([Mercury](https://mercury.com/)): Checking account, invoices, wire transfers (international and domestic), debit cards
    6. Secondary Bank ([Fidelity](https://www.fidelity.com/open-account/fidelity-account-for-businesses)): Competitive money market rate for cash holdings. Backup account.
    7. Solo 401k ([Fidelity](https://www.fidelity.com/retirement-ira/small-business/self-employed-401k/overview)): Reduce taxes, save for retirement, allow for backdoor Roth IRA contributions in perpetuity.
