...
1. **Have Fun**: I have a lot of passions and a lot of opinions. I want this site to be me and I want to have fun with it. If I want to write about D&D or [Brotato](https://store.steampowered.com/app/1942280/Brotato/), I will. 
...
3. **Make New Connections**: When I get bored, I like to read  [lobste.rs](https://lobste.rs/). Many of the posts come from personal sites and I follow the authors from there. I'm a peculiar person, I'd like to meet other peculiar people.
...
## financeidiot.com
My first personal website was financeidiot.com (no longer active). I wrote a few posts there when I was into the [financial indepence retire early (FIRE) movement](https://en.wikipedia.org/wiki/FIRE_movement). I was interested in FIRE, but I felt insecure posting about financial topics (hence the self-deprecating name) and after 2-3 posts, I didn't have anything new to say. A financial strategy that boils down to: (1) high income, (2) low expenses, (3) low-cost index funds, and (4) waiting doesn't require regular updates. The [Mad Fientist](https://www.madfientist.com/) and [Finance Buff](https://thefinancebuff.com/) have already written what I would say better than I could. 
...
Around the same time, I took a strong interest in [Replit](https://replit.com/) and Python. I completed the [Replit 100 Days of code](https://blog.replit.com/100-days-of-code) Python course in full and had a blast! Part of the course required using Flask to setup simple Python websites and when I upgraded to the Replit Core plan, I had a lot of free credits leftover for hosting. 
